 ...
 *  Launch Android Studio -> Choose File -> Open and navigate to the extracted root folder.
3. Project Sync & Build:
 *  Wait for Gradle to automatically download dependencies and compile resource trees (Target API level: 35).
